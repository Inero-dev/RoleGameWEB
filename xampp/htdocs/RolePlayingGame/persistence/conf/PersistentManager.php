...
class PersistentManager {
    ...
    private function __construct() {
        ...
        PersistentManager::$connection = mysqli_connect($this->hostBD, $this->userBD, $this->psswdBD, $this->nameBD, $this->portBD)
